...
public class RouteServiceImpl implements RouteService {
    ...
    public List<RouteBean> findByStartStationid(Integer stationid) {
        RouteBeanExample routeBeanExample = new RouteBeanExample();
        routeBeanExample.clear();
        routeBeanExample.createCriteria().andStartstationidEqualTo(stationid);
        return routeBeanMapper.selectByExample(routeBeanExample);
    }
    ...
    public List<RouteBean> findByEndStationid(Integer stationid) {
        RouteBeanExample routeBeanExample = new RouteBeanExample();
        routeBeanExample.clear();
        routeBeanExample.createCriteria().andEndstationidEqualTo(stationid);
        return routeBeanMapper.selectByExample(routeBeanExample);
    }
    ...
    public List<RouteBean> findByStartEndStationid(Integer startid, Integer endid) {
        RouteBeanExample routeBeanExample = new RouteBeanExample();
        routeBeanExample.clear();
        routeBeanExample.createCriteria().andStartstationidEqualTo(startid).andEndstationidEqualTo(endid);
        return routeBeanMapper.selectByExample(routeBeanExample);
    }
